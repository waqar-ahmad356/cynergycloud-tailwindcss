      ...
      <div className="flex flex-col lg:flex-row lg:py-[120px] lg:justify-center lg:gap[94px] gap-[49px]">
        ...
        <h2 className="text-[#0F172A] text-[30px] lg:text-[56px] font-semibold">Sign Up</h2>
          <form className="flex flex-col items-start justify-between gap-[36px]">
            ...
            <button type="submit" className="flex justify-center items-center bg-[#22739C] border-[1.2px] lg:border-[2.5px]
            border-[#22739C] py-[12px] lg:py-[24px] lg:px-[28px] px-[15px] rounded-full lg:w-[276px] lg:h-[76px] text-[white] lg:text-[21px] text-[11px] font-bold w-[146px] h-[40px] " >
              Create Account
            </button>
          </form>
